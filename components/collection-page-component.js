  ...
  template: /* html */ `
    <section class="container py-4">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3 mb-0"><i class="bi bi-exclamation-triangle me-2"></i>Security Incidents</h1>
        <span class="badge text-bg-light border">{{ itemsStore.items.length }} incidents</span>
      </div>

      <p class="text-muted">Incidents logged during the current investigation. Click any incident to view full details.</p>
